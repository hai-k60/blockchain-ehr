    ...
    success: function(data) {
      ...
      if (data.error) {
        ...
        $('.view-healthRecord').html(function() {
          var str = '<h3> Health Record Information</h3>';
          str = str + '<b style="color:red;">Temperature: </b>' + data.temperature +'<br>';
          str = str + '<b style="color:red;">Blood Pressure: </b>' + data.bloodPressure +'<br>'; 
          str = str + '<br><h3> Patient Information</h3>';
